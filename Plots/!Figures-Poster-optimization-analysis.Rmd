...
shapes <- c(15,16,17,4)
g1 <- ggplot(data = tmp, aes(x=solving_time/1000, y=numOfInstances, group=Approach,color=Approach)) +
  geom_line(size=2)+ #aes(linetype=Approach)
  geom_point(aes(shape=Approach),size=3)+ 
  labs(x="Time (1000s)", y = "# of Instances Solved")+
...
if (forpres)
{
  ggsave(paste(figure_path,"class_perf_opt_no_regularization_presentation.pdf",sep = ""),device = "pdf", width = 9, height = 5, units =  "in")
} else {
